...
.method constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/transition/ai;)V
    ...
    iput-object p1, p0, Landroid/support/transition/ai$a;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1}, Landroid/support/transition/ai$a;->setRight(I)V

    invoke-virtual {p2}, Landroid/view/ViewGroup;->getHeight()I

    move-result p1

    invoke-virtual {p0, p1}, Landroid/support/transition/ai$a;->setBottom(I)V
...
.method public final a(Landroid/view/View;)V
    ...
    iget-object v2, p0, Landroid/support/transition/ai$a;->b:Landroid/view/ViewGroup;
    ...
    iget-object v4, p0, Landroid/support/transition/ai$a;->b:Landroid/view/ViewGroup;
    ...
    invoke-static {p1, v5}, Landroid/support/v4/view/r;->c(Landroid/view/View;I)V
    ...
    invoke-static {p1, v3}, Landroid/support/v4/view/r;->b(Landroid/view/View;I)V
...
.method public final b(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/transition/ai$a;->d:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Landroid/support/transition/ai$a;->b:Landroid/view/ViewGroup;
...
.method protected final dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/support/transition/ai$a;->c:Landroid/view/View;
...
.method public final invalidateChildInParent([ILandroid/graphics/Rect;)Landroid/view/ViewParent;
    ...
    iget-object v5, p0, Landroid/support/transition/ai$a;->b:Landroid/view/ViewGroup;

    invoke-virtual {v5, v4}, Landroid/view/ViewGroup;->getLocationOnScreen([I)V

    iget-object v5, p0, Landroid/support/transition/ai$a;->c:Landroid/view/View;
...
.method public final invalidateDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/transition/ai$a;->invalidate(Landroid/graphics/Rect;)V
