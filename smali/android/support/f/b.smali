...
.method static a(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/f/b;->b(Ljava/io/File;)J
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/f/b;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/f/b;->a(Ljava/io/File;)J
    ...
    :try_start_3
    invoke-static/range {p0 .. p3}, Landroid/support/f/b;->b(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/util/List;
    ...
    :catch_0
    :try_start_4
    invoke-static/range {p1 .. p2}, Landroid/support/f/b;->a(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    invoke-static/range {v1 .. v7}, Landroid/support/f/b;->a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    invoke-static {v11}, Landroid/support/f/b;->a(Ljava/io/Closeable;)V

    :cond_4
    invoke-static {v9}, Landroid/support/f/b;->a(Ljava/io/Closeable;)V
...
.method private static a(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    invoke-static {p1, v0}, Landroid/support/f/b;->a(Ljava/io/File;Ljava/lang/String;)V
    ...
    new-instance v5, Landroid/support/f/b$a;

    invoke-direct {v5, p1, v4}, Landroid/support/f/b$a;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v2, v3, v5, v0}, Landroid/support/f/b;->a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v5}, Landroid/support/f/b;->b(Ljava/io/File;)J

    move-result-wide v7

    iput-wide v7, v5, Landroid/support/f/b$a;->a:J
    :try_end_1
    ...
    invoke-virtual {v5}, Landroid/support/f/b$a;->getAbsolutePath()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Landroid/support/f/b$a;->length()J
    ...
    iget-wide v9, v5, Landroid/support/f/b$a;->a:J

    invoke-virtual {v8, v9, v10}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    if-nez v7, :cond_0

    invoke-virtual {v5}, Landroid/support/f/b$a;->delete()Z

    invoke-virtual {v5}, Landroid/support/f/b$a;->exists()Z
    ...
    invoke-virtual {v5}, Landroid/support/f/b$a;->getPath()Ljava/lang/String;
...
.method private static a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    invoke-static {p0}, Landroid/support/f/b;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    check-cast p4, Landroid/support/f/b$a;
    ...
    iget-wide v0, p4, Landroid/support/f/b$a;->a:J
    ...
    invoke-virtual {p4}, Landroid/support/f/b$a;->lastModified()J
...
.method private static a(Ljava/io/File;Ljava/lang/String;)V
    ...
    new-instance v0, Landroid/support/f/b$1;

    invoke-direct {v0, p1}, Landroid/support/f/b$1;-><init>(Ljava/lang/String;)V
...
.method private static a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-static {p0}, Landroid/support/f/b;->a(Ljava/io/Closeable;)V
...
.method private static b(Ljava/io/File;)J
    ...
    invoke-static {p0}, Landroid/support/f/c;->a(Ljava/io/File;)J
...
.method private static b(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/util/List;
    ...
    new-instance v7, Landroid/support/f/b$a;

    move-object/from16 v8, p2

    invoke-direct {v7, v8, v6}, Landroid/support/f/b$a;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-virtual {v7}, Landroid/support/f/b$a;->isFile()Z

    move-result v6

    if-eqz v6, :cond_2

    invoke-static {v7}, Landroid/support/f/b;->b(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v7, Landroid/support/f/b$a;->a:J
    ...
    invoke-virtual {v7}, Landroid/support/f/b$a;->lastModified()J
    ...
    iget-wide v1, v7, Landroid/support/f/b$a;->a:J
    ...
    iget-wide v3, v7, Landroid/support/f/b$a;->a:J
    ...
    invoke-virtual {v7}, Landroid/support/f/b$a;->getPath()Ljava/lang/String;
