...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, v3}, Landroid/support/v4/widget/c;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/c;
    ...
    invoke-direct {v2, v3}, Landroid/support/v4/widget/d;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/widget/d;

    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:Landroid/support/v4/widget/d;

    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/d;->a(I)V
    ...
    invoke-virtual {v2, v4}, Landroid/support/v4/widget/c;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/c;

    const/16 v4, 0x8

    invoke-virtual {v2, v4}, Landroid/support/v4/widget/c;->setVisibility(I)V
...
.method private a(ZZ)V
    ...
    iput-object p2, p1, Landroid/support/v4/widget/c;->a:Landroid/view/animation/Animation$AnimationListener;
...
.method private b(F)V
    ...
    iget v7, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:I
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->b(II)Landroid/view/animation/Animation;
    ...
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/d;->b(F)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/widget/d;->a(F)V
    ...
    iput p1, v1, Landroid/support/v4/widget/d$a;->g:F
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->r:Landroid/support/v4/view/n;
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    iput v0, p1, Landroid/support/v4/view/n;->a:I
...
.method public varargs setColorSchemeColors([I)V
    ...
    iget-object p1, v0, Landroid/support/v4/widget/d;->a:Landroid/support/v4/widget/d$a;

    const/4 v1, 0x0

    invoke-virtual {p1, v1}, Landroid/support/v4/widget/d$a;->a(I)V
...
.method public setRefreshing(Z)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/widget/c;->setVisibility(I)V
...
.method setTargetOffsetTopAndBottom(I)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/view/r;->b(Landroid/view/View;I)V
