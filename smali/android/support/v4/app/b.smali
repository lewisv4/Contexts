...
.method private a(ILandroid/support/v4/app/h;Ljava/lang/String;I)V
    ...
    iput-object v0, p2, Landroid/support/v4/app/h;->mFragmentManager:Landroid/support/v4/app/n;

    if-eqz p3, :cond_2

    iget-object v0, p2, Landroid/support/v4/app/h;->mTag:Ljava/lang/String;
    ...
    iget-object p2, p2, Landroid/support/v4/app/h;->mTag:Ljava/lang/String;
    ...
    :cond_1
    iput-object p3, p2, Landroid/support/v4/app/h;->mTag:Ljava/lang/String;
    ...
    :cond_3
    iget p3, p2, Landroid/support/v4/app/h;->mFragmentId:I
    ...
    iget p2, p2, Landroid/support/v4/app/h;->mFragmentId:I
    ...
    :cond_4
    iput p1, p2, Landroid/support/v4/app/h;->mFragmentId:I

    iput p1, p2, Landroid/support/v4/app/h;->mContainerId:I

    :cond_5
    new-instance p1, Landroid/support/v4/app/b$a;

    invoke-direct {p1, p4, p2}, Landroid/support/v4/app/b$a;-><init>(ILandroid/support/v4/app/h;)V
...
.method static b(Landroid/support/v4/app/b$a;)Z
    ...
    iget-object p0, p0, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/h;->isPostponed()Z
...
# virtual methods
.method final a(Ljava/util/ArrayList;Landroid/support/v4/app/h;)Landroid/support/v4/app/h;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v4, v5, v1}, Landroid/support/v4/app/b$a;-><init>(ILandroid/support/v4/app/h;)V

    invoke-virtual {v3, p2, v4}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    add-int/lit8 p2, p2, 0x1

    iget-object v1, v2, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    goto/16 :goto_4

    :pswitch_2
    iget-object v3, v2, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;
    ...
    iget-object v2, v2, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    invoke-direct {v3, v5, v2}, Landroid/support/v4/app/b$a;-><init>(ILandroid/support/v4/app/h;)V
    ...
    iget v7, v3, Landroid/support/v4/app/h;->mContainerId:I
    ...
    iget v11, v10, Landroid/support/v4/app/h;->mContainerId:I
    ...
    invoke-direct {v11, v5, v10}, Landroid/support/v4/app/b$a;-><init>(ILandroid/support/v4/app/h;)V
    ...
    invoke-direct {v11, v12, v10}, Landroid/support/v4/app/b$a;-><init>(ILandroid/support/v4/app/h;)V
...
.method public final a(ILandroid/support/v4/app/h;)Landroid/support/v4/app/t;
    .locals 2
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Landroid/support/v4/app/b;->a(ILandroid/support/v4/app/h;Ljava/lang/String;I)V

    return-object p0
.end method

.method public final a(ILandroid/support/v4/app/h;Ljava/lang/String;)Landroid/support/v4/app/t;
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v4/app/b;->a(ILandroid/support/v4/app/h;Ljava/lang/String;I)V

    return-object p0
.end method

.method public final a(Landroid/support/v4/app/h;)Landroid/support/v4/app/t;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/app/b$a;-><init>(ILandroid/support/v4/app/h;)V
...
.method public final a(Landroid/support/v4/app/h;Ljava/lang/String;)Landroid/support/v4/app/t;
    .locals 2
    ...
    invoke-direct {p0, v0, p1, p2, v1}, Landroid/support/v4/app/b;->a(ILandroid/support/v4/app/h;Ljava/lang/String;I)V
...
.method final a(I)V
    ...
    iget v4, v3, Landroid/support/v4/app/h;->mBackStackNesting:I

    add-int/2addr v4, p1

    iput v4, v3, Landroid/support/v4/app/h;->mBackStackNesting:I
    ...
    iget-object v4, v2, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;
    ...
    iget v2, v2, Landroid/support/v4/app/h;->mBackStackNesting:I
...
.method final a(Landroid/support/v4/app/h$c;)V
    ...
    iget-object v1, v1, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    invoke-virtual {v1, p1}, Landroid/support/v4/app/h;->setOnStartEnterTransitionListener(Landroid/support/v4/app/h$c;)V
...
.method final a(Z)V
    ...
    invoke-virtual {v3, v4, v5}, Landroid/support/v4/app/h;->setNextTransition(II)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v4/app/n;->j(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/h;->setNextAnim(I)V
    ...
    invoke-static {v3}, Landroid/support/v4/app/n;->f(Landroid/support/v4/app/h;)V
    ...
    invoke-static {v3}, Landroid/support/v4/app/n;->g(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/n;->e(Landroid/support/v4/app/h;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/b;->a:Landroid/support/v4/app/n;

    invoke-virtual {v2, v3}, Landroid/support/v4/app/n;->c(Landroid/support/v4/app/h;)V
    ...
    iget-object p1, p0, Landroid/support/v4/app/b;->a:Landroid/support/v4/app/n;
...
.method final a(Ljava/util/ArrayList;II)Z
    ...
    iget-object v5, v4, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    if-eqz v5, :cond_1

    iget-object v4, v4, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    iget v4, v4, Landroid/support/v4/app/h;->mContainerId:I
    ...
    iget-object v9, v8, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    if-eqz v9, :cond_2

    iget-object v8, v8, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    iget v8, v8, Landroid/support/v4/app/h;->mContainerId:I
...
.method public final a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    iget-object p2, p1, Landroid/support/v4/app/n;->g:Ljava/util/ArrayList;
    ...
    iput-object p2, p1, Landroid/support/v4/app/n;->g:Ljava/util/ArrayList;

    :cond_1
    iget-object p1, p1, Landroid/support/v4/app/n;->g:Ljava/util/ArrayList;
...
.method final b(Ljava/util/ArrayList;Landroid/support/v4/app/h;)Landroid/support/v4/app/h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :pswitch_0
    iget-object p2, v1, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;
...
.method public final b(ILandroid/support/v4/app/h;)Landroid/support/v4/app/t;
    .locals 2
...
.method public final b(Landroid/support/v4/app/h;)Landroid/support/v4/app/t;
    .locals 2
...
.method final b(I)Z
    ...
    iget-object v4, v3, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    if-eqz v4, :cond_0

    iget-object v3, v3, Landroid/support/v4/app/b$a;->b:Landroid/support/v4/app/h;

    iget v3, v3, Landroid/support/v4/app/h;->mContainerId:I
...
.method public final c(Landroid/support/v4/app/h;)Landroid/support/v4/app/t;
    .locals 2
...
.method public final d(Landroid/support/v4/app/h;)Landroid/support/v4/app/t;
    .locals 2
...
.method public final d()V
    ...
    iget-object v1, v0, Landroid/support/v4/app/n;->m:Landroid/support/v4/app/l;

    if-eqz v1, :cond_3

    iget-boolean v1, v0, Landroid/support/v4/app/n;->u:Z
    ...
    iget-object v1, v0, Landroid/support/v4/app/n;->x:Ljava/util/ArrayList;

    iget-object v2, v0, Landroid/support/v4/app/n;->y:Ljava/util/ArrayList;

    invoke-interface {p0, v1, v2}, Landroid/support/v4/app/n$g;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    iput-boolean v1, v0, Landroid/support/v4/app/n;->c:Z
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/app/n;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_0
...
.method public final e(Landroid/support/v4/app/h;)Landroid/support/v4/app/t;
    .locals 2
...
.method final e()V
    ...
    invoke-virtual {v5, v6, v7}, Landroid/support/v4/app/h;->setNextTransition(II)V
    ...
    :pswitch_0
    iget-object v6, p0, Landroid/support/v4/app/b;->a:Landroid/support/v4/app/n;

    const/4 v7, 0x0

    invoke-virtual {v6, v7}, Landroid/support/v4/app/n;->j(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v4/app/h;->setNextAnim(I)V
    ...
    invoke-static {v5}, Landroid/support/v4/app/n;->g(Landroid/support/v4/app/h;)V
    ...
    invoke-static {v5}, Landroid/support/v4/app/n;->f(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/n;->e(Landroid/support/v4/app/h;)V
    ...
    iget-object v3, p0, Landroid/support/v4/app/b;->a:Landroid/support/v4/app/n;

    invoke-virtual {v3, v5}, Landroid/support/v4/app/n;->c(Landroid/support/v4/app/h;)V
