...
.method constructor <init>(Landroid/support/design/widget/w;Landroid/support/design/widget/m;)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/h;-><init>(Landroid/support/design/widget/w;Landroid/support/design/widget/m;)V
...
.method final a(FF)V
    ...
    iget-object p1, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/w;

    invoke-virtual {p1}, Landroid/support/design/widget/w;->isFocused()Z
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/w;->isPressed()Z
    ...
    invoke-virtual {p1, p2}, Landroid/support/design/widget/w;->setTranslationZ(F)V
    ...
    invoke-virtual {p1, v1}, Landroid/support/design/widget/w;->setElevation(F)V

    :cond_2
    iget-object p1, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/w;

    invoke-virtual {p1, v1}, Landroid/support/design/widget/w;->setTranslationZ(F)V
    ...
    iget-object v4, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/w;
    ...
    sget-object v3, Landroid/support/design/widget/i;->a:Landroid/view/animation/Interpolator;

    invoke-virtual {v2, v3}, Landroid/animation/AnimatorSet;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    sget-object v3, Landroid/support/design/widget/i;->k:[I
    ...
    sget-object p2, Landroid/support/design/widget/i;->a:Landroid/view/animation/Interpolator;
    ...
    iget-object v6, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/w;

    invoke-virtual {v6}, Landroid/support/design/widget/w;->getTranslationZ()F
    ...
    sget-object p1, Landroid/support/design/widget/i;->a:Landroid/view/animation/Interpolator;

    invoke-virtual {p2, p1}, Landroid/animation/AnimatorSet;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    sget-object p1, Landroid/support/design/widget/i;->m:[I
    ...
    iget-object p2, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/w;
    ...
    sget-object p2, Landroid/support/design/widget/i;->n:[I

    invoke-virtual {v0, p2, p1}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    iget-object p1, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/w;

    invoke-virtual {p1, v0}, Landroid/support/design/widget/w;->setStateListAnimator(Landroid/animation/StateListAnimator;)V

    :goto_0
    iget-object p1, p0, Landroid/support/design/widget/i;->p:Landroid/support/design/widget/m;
...
.method final a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/i;->g:Landroid/support/design/widget/d;
    ...
    iget-object v1, p0, Landroid/support/design/widget/i;->g:Landroid/support/design/widget/d;
    ...
    :cond_1
    iput-object p2, p0, Landroid/support/design/widget/i;->g:Landroid/support/design/widget/d;
    ...
    iget-object p1, p0, Landroid/support/design/widget/i;->f:Landroid/graphics/drawable/Drawable;

    iput-object p1, p0, Landroid/support/design/widget/i;->h:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, Landroid/support/design/widget/i;->p:Landroid/support/design/widget/m;

    iget-object p2, p0, Landroid/support/design/widget/i;->f:Landroid/graphics/drawable/Drawable;
...
.method final a(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/i;->p:Landroid/support/design/widget/m;
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/w;->getElevation()F
...
.method final b(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/i;->r:Landroid/graphics/drawable/InsetDrawable;
...
.method final f()Landroid/support/design/widget/d;
    .locals 1
