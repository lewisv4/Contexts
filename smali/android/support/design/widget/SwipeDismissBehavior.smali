...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/v4/widget/s;
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v4/widget/s;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/s$a;)Landroid/support/v4/widget/s;
    ...
    :cond_1
    iget-object p2, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/s$a;

    invoke-static {p1, p2}, Landroid/support/v4/widget/s;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/s$a;)Landroid/support/v4/widget/s;

    move-result-object p1

    :goto_1
    iput-object p1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/v4/widget/s;

    :cond_2
    iget-object p1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/v4/widget/s;

    invoke-virtual {p1, p3}, Landroid/support/v4/widget/s;->a(Landroid/view/MotionEvent;)Z
