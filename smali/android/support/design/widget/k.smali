...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/k;->a:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Landroid/support/design/widget/k;->b:Landroid/graphics/Rect;

    const/4 p1, 0x0

    iput p1, p0, Landroid/support/design/widget/k;->c:I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-virtual {v0, v3}, Landroid/support/design/widget/k;->a(Ljava/util/List;)Landroid/view/View;
    ...
    invoke-static {v4, v5}, Landroid/support/v4/view/r;->b(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/design/widget/k;->c(Landroid/view/View;)I
...
.method protected final c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/k;->a(Ljava/util/List;)Landroid/view/View;
    ...
    iget-object v5, p0, Landroid/support/design/widget/k;->a:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/design/widget/k;->b:Landroid/graphics/Rect;
    ...
    invoke-static/range {v2 .. v7}, Landroid/support/v4/view/e;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V

    invoke-virtual {p0, v0}, Landroid/support/design/widget/k;->d(Landroid/view/View;)I
    ...
    :cond_2
    invoke-super {p0, p1, p2, p3}, Landroid/support/design/widget/r;->c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
...
.method final d(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/design/widget/k;->b(Landroid/view/View;)F
