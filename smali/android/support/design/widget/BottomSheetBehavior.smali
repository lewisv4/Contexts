...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->l:F
...
.method public final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[I)V
    ...
    invoke-static {p2, p1}, Landroid/support/v4/view/r;->b(Landroid/view/View;I)V
...
.method public final a(Landroid/view/View;Landroid/view/View;)V
    ...
    :cond_1
    iget p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->r:I
    ...
    iget v3, p0, Landroid/support/design/widget/BottomSheetBehavior;->l:F
    ...
    invoke-virtual {v0, p1, v1, p2}, Landroid/support/v4/widget/s;->a(Landroid/view/View;II)Z
    ...
    invoke-direct {p2, p0, p1, v2}, Landroid/support/design/widget/BottomSheetBehavior$c;-><init>(Landroid/support/design/widget/BottomSheetBehavior;Landroid/view/View;I)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->s:Z
...
.method public final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-static {p2, v1}, Landroid/support/v4/view/r;->b(Landroid/view/View;Z)V
    ...
    iget-boolean p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->n:Z

    if-eqz p3, :cond_2

    iget p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->o:I
    ...
    iput p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->o:I
    ...
    :cond_2
    iget p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:I
    ...
    :goto_1
    invoke-static {p2, p3}, Landroid/support/v4/view/r;->b(Landroid/view/View;I)V
    ...
    :cond_7
    :goto_2
    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/s;

    if-nez p3, :cond_8

    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->v:Landroid/support/v4/widget/s$a;
    ...
    iput-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/s;
...
.method public final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :goto_1
    iput-boolean p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->q:Z
    ...
    iput v4, p0, Landroid/support/design/widget/BottomSheetBehavior;->j:I

    iget-boolean p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->q:Z
    ...
    iget-object p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/s;
    ...
    iget p2, p2, Landroid/support/v4/widget/s;->a:I
...
.method final a(Landroid/view/View;F)Z
    ...
    iget p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->m:I
...
.method public final b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1, p3}, Landroid/support/v4/widget/s;->b(Landroid/view/MotionEvent;)V
    ...
    iget-boolean p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->q:Z
    ...
    iget v1, v1, Landroid/support/v4/widget/s;->a:I
    ...
    iget-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/s;
