...
.method public constructor <init>(Landroid/support/v7/app/q;Landroid/content/Context;Landroid/support/v7/view/b$a;)V
    ...
    iput-object p1, p0, Landroid/support/v7/app/q$a;->b:Landroid/support/v7/app/q;

    invoke-direct {p0}, Landroid/support/v7/view/b;-><init>()V

    iput-object p2, p0, Landroid/support/v7/app/q$a;->e:Landroid/content/Context;

    iput-object p3, p0, Landroid/support/v7/app/q$a;->f:Landroid/support/v7/view/b$a;
    ...
    iput-object p1, p0, Landroid/support/v7/app/q$a;->a:Landroid/support/v7/view/menu/h;

    iget-object p1, p0, Landroid/support/v7/app/q$a;->a:Landroid/support/v7/view/menu/h;
...
.method public final a()Landroid/view/MenuInflater;
    ...
    iget-object v1, p0, Landroid/support/v7/app/q$a;->e:Landroid/content/Context;
...
.method public final a(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/q$a;->b:Landroid/support/v7/app/q;
...
.method public final a(Landroid/support/v7/view/menu/h;)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/q$a;->f:Landroid/support/v7/view/b$a;
    ...
    iget-object p1, p0, Landroid/support/v7/app/q$a;->b:Landroid/support/v7/app/q;
...
.method public final a(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/q$a;->g:Ljava/lang/ref/WeakReference;
...
.method public final b()Landroid/view/Menu;
    ...
    iget-object v0, p0, Landroid/support/v7/app/q$a;->a:Landroid/support/v7/view/menu/h;
...
.method public final c()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/q$a;->b:Landroid/support/v7/app/q;
    ...
    iget-object v1, p0, Landroid/support/v7/app/q$a;->f:Landroid/support/v7/view/b$a;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/q$a;->f:Landroid/support/v7/view/b$a;
    ...
    iput-object v0, p0, Landroid/support/v7/app/q$a;->f:Landroid/support/v7/view/b$a;

    iget-object v1, p0, Landroid/support/v7/app/q$a;->b:Landroid/support/v7/app/q;

    invoke-virtual {v1, v2}, Landroid/support/v7/app/q;->f(Z)V
    ...
    iget-object v1, v1, Landroid/support/v7/app/q;->d:Landroid/support/v7/widget/ak;
    ...
    iget-object v2, p0, Landroid/support/v7/app/q$a;->b:Landroid/support/v7/app/q;
...
.method public final d()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/q$a;->a:Landroid/support/v7/view/menu/h;
...
.method public final i()Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/app/q$a;->g:Ljava/lang/ref/WeakReference;
