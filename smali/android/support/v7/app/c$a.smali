...
.method public final a(Landroid/content/DialogInterface$OnCancelListener;)Landroid/support/v7/app/c$a;
    .locals 1
...
.method public final a()Landroid/support/v7/app/c;
    ...
    iget v3, v0, Landroid/support/v7/app/c$a;->b:I

    invoke-direct {v1, v2, v3}, Landroid/support/v7/app/c;-><init>(Landroid/content/Context;I)V

    iget-object v2, v0, Landroid/support/v7/app/c$a;->a:Landroid/support/v7/app/AlertController$a;

    iget-object v10, v1, Landroid/support/v7/app/c;->a:Landroid/support/v7/app/AlertController;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/c;->setCancelable(Z)V
    ...
    invoke-virtual {v1, v11}, Landroid/support/v7/app/c;->setCanceledOnTouchOutside(Z)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/c;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)V

    iget-object v2, v0, Landroid/support/v7/app/c$a;->a:Landroid/support/v7/app/AlertController$a;

    iget-object v2, v2, Landroid/support/v7/app/AlertController$a;->t:Landroid/content/DialogInterface$OnDismissListener;

    invoke-virtual {v1, v2}, Landroid/support/v7/app/c;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/c;->setOnKeyListener(Landroid/content/DialogInterface$OnKeyListener;)V
...
.method public final b()Landroid/support/v7/app/c;
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/c$a;->a()Landroid/support/v7/app/c;
