...
.method constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    invoke-direct {v0, p1, v1}, Landroid/support/v7/widget/bt;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/app/n;->a:Landroid/support/v7/widget/ak;
    ...
    iget-object p3, p0, Landroid/support/v7/app/n;->a:Landroid/support/v7/widget/ak;

    iget-object v0, p0, Landroid/support/v7/app/n;->c:Landroid/view/Window$Callback;

    invoke-interface {p3, v0}, Landroid/support/v7/widget/ak;->a(Landroid/view/Window$Callback;)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/n;->a:Landroid/support/v7/widget/ak;

    invoke-interface {p1, p2}, Landroid/support/v7/widget/ak;->a(Ljava/lang/CharSequence;)V
...
.method public final a()I
    ...
    iget-object v0, p0, Landroid/support/v7/app/n;->a:Landroid/support/v7/widget/ak;
...
.method public final a(Z)V
    ...
    :goto_0
    iget-object v1, p0, Landroid/support/v7/app/n;->a:Landroid/support/v7/widget/ak;

    invoke-interface {v1}, Landroid/support/v7/widget/ak;->m()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/app/n;->a:Landroid/support/v7/widget/ak;
...
.method public final a(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/n;->h()Landroid/view/Menu;
...
.method public final d(Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/n;->f:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroid/support/v7/app/n;->f:Ljava/util/ArrayList;
...
.method final h()Landroid/view/Menu;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ak;->o()Landroid/view/Menu;
