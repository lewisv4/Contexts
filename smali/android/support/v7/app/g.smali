...
.method static constructor <clinit>()V
    ...
    sput-boolean v2, Landroid/support/v7/app/g;->p:Z
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/e;)V
    ...
    iget-object p2, p0, Landroid/support/v7/app/g;->c:Landroid/view/Window;

    invoke-virtual {p2}, Landroid/view/Window;->getCallback()Landroid/view/Window$Callback;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/app/g;->d:Landroid/view/Window$Callback;

    iget-object p2, p0, Landroid/support/v7/app/g;->d:Landroid/view/Window$Callback;

    instance-of p2, p2, Landroid/support/v7/app/g$b;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/app/g;->a(Landroid/view/Window$Callback;)Landroid/view/Window$Callback;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/app/g;->e:Landroid/view/Window$Callback;

    iget-object p2, p0, Landroid/support/v7/app/g;->c:Landroid/view/Window;

    iget-object p3, p0, Landroid/support/v7/app/g;->e:Landroid/view/Window$Callback;

    invoke-virtual {p2, p3}, Landroid/view/Window;->setCallback(Landroid/view/Window$Callback;)V

    const/4 p2, 0x0

    sget-object p3, Landroid/support/v7/app/g;->r:[I

    invoke-static {p1, p2, p3}, Landroid/support/v7/widget/bs;->a(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroid/support/v7/widget/bs;
    ...
    iget-object p3, p0, Landroid/support/v7/app/g;->c:Landroid/view/Window;
...
.method public final b()Landroid/view/MenuInflater;
    ...
    iget-object v1, p0, Landroid/support/v7/app/g;->g:Landroid/support/v7/app/a;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/g;->b:Landroid/content/Context;

    :goto_0
    invoke-direct {v0, v1}, Landroid/support/v7/view/g;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/app/g;->h:Landroid/view/MenuInflater;
