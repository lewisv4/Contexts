...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, v0, p3, p4}, Landroid/support/v7/widget/bs;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bs;
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/bs;->a(IZ)Z

    move-result p2

    sget-boolean p3, Landroid/support/v7/widget/s;->a:Z

    if-eqz p3, :cond_0

    iput-boolean p2, p0, Landroid/support/v7/widget/s;->b:Z

    goto :goto_0

    :cond_0
    invoke-static {p0, p2}, Landroid/support/v4/widget/l;->a(Landroid/widget/PopupWindow;Z)V
