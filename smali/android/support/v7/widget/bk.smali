...
.method public final a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$b;Landroid/support/v7/widget/RecyclerView$f$b;)Z
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/bk;->a(Landroid/support/v7/widget/RecyclerView$x;IIII)Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bk;->a(Landroid/support/v7/widget/RecyclerView$x;)Z
...
.method public final a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$b;Landroid/support/v7/widget/RecyclerView$f$b;)Z
    ...
    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$x;->b()Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v7/widget/bk;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$x;IIII)Z
...
.method public final b(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$b;Landroid/support/v7/widget/RecyclerView$f$b;)Z
    .locals 8
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/support/v7/widget/bk;->a(Landroid/support/v7/widget/RecyclerView$x;IIII)Z
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bk;->b(Landroid/support/v7/widget/RecyclerView$x;)Z
...
.method public final c(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$b;Landroid/support/v7/widget/RecyclerView$f$b;)Z
    .locals 6
...
.method public final f(Landroid/support/v7/widget/RecyclerView$x;)Z
    .locals 1
