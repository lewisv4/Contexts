...
.method final a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aa;->f:Landroid/support/v7/widget/bq;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aa;->g:Landroid/support/v7/widget/bq;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aa;->f:Landroid/support/v7/widget/bq;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/aa;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bq;)V

    const/4 v1, 0x2

    aget-object v0, v0, v1

    iget-object v1, p0, Landroid/support/v7/widget/aa;->g:Landroid/support/v7/widget/bq;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/aa;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bq;)V
...
.method final a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, v1, p2}, Landroid/support/v7/widget/aa;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bq;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/aa;->f:Landroid/support/v7/widget/bq;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/aa;->g:Landroid/support/v7/widget/bq;
