...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput v1, p0, Landroid/support/v7/widget/az$a;->a:I

    iput v0, p0, Landroid/support/v7/widget/az$a;->b:I
    ...
    iput v1, p0, Landroid/support/v7/widget/az$a;->b:I
...
.method public final onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/az$a;->c:Landroid/support/v7/widget/ay;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/az$a;->d:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/az$a;->c:Landroid/support/v7/widget/ay;

    invoke-interface {v3, v0, v1}, Landroid/support/v7/widget/ay;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v2, p0, Landroid/support/v7/widget/az$a;->d:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    iget-object v1, p0, Landroid/support/v7/widget/az$a;->c:Landroid/support/v7/widget/ay;

    invoke-interface {v1, v0, v2}, Landroid/support/v7/widget/ay;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/az$a;->a:I
    ...
    invoke-virtual {p0, v0, p1, v2, v3}, Landroid/support/v7/widget/az$a;->performItemClick(Landroid/view/View;IJ)Z
    ...
    iget v0, p0, Landroid/support/v7/widget/az$a;->b:I

    if-ne p1, v0, :cond_2

    const/4 p1, -0x1

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/az$a;->setSelection(I)V
    ...
    iget-object p1, p1, Landroid/support/v7/view/menu/g;->b:Landroid/support/v7/view/menu/h;
...
.method public final setHoverListener(Landroid/support/v7/widget/ay;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/az$a;->c:Landroid/support/v7/widget/ay;
