...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/au;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p2, p3, v0}, Landroid/support/v7/widget/bs;->g(II)I
    ...
    invoke-virtual {p2, p3}, Landroid/support/v7/widget/bs;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v7/widget/bs;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p3}, Landroid/support/v7/widget/bu;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1, p3}, Landroid/support/v7/widget/bs;->g(II)I
    ...
    invoke-virtual {p2, p1, v1}, Landroid/support/v7/widget/bs;->g(II)I
    ...
    invoke-virtual {p2, p1, v0}, Landroid/support/v7/widget/bs;->a(IZ)Z
    ...
    invoke-virtual {p2, p1, p3}, Landroid/support/v7/widget/bs;->e(II)I
    ...
    invoke-virtual {p2, p1}, Landroid/support/v7/widget/bs;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1, p3}, Landroid/support/v7/widget/bs;->a(II)I
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bm;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Landroid/support/v4/widget/f;

    invoke-virtual {p1, v1}, Landroid/support/v4/widget/f;->b(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-direct {v0, v1, p0, v3, v4}, Landroid/support/v7/widget/bm;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    :cond_2
    iput v2, v0, Landroid/support/v7/widget/bm;->j:I
...
.method public clearFocus()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/au;->clearFocus()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/au;->onDetachedFromWindow()V
...
.method onItemClicked(IILjava/lang/String;)Z
    ...
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/SearchView$d;
    ...
    invoke-interface {p2}, Landroid/support/v7/widget/SearchView$d;->b()Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Landroid/support/v7/widget/au;->onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Landroid/support/v7/widget/SearchView$f;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Landroid/support/v7/widget/SearchView$f;
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/au;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/au;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Landroid/support/v7/widget/au;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-super {p0}, Landroid/support/v7/widget/au;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/SearchView$a;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method public onWindowFocusChanged(Z)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/au;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    :cond_3
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/au;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v0, v0, Landroid/support/v7/widget/bm;
