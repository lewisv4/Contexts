...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/au;-><init>(Landroid/content/Context;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget v7, v6, Landroid/support/v7/widget/au$a;->h:I
    ...
    invoke-static {v7, v8}, Landroid/support/v4/view/e;->a(II)I
    ...
    iget v7, v6, Landroid/support/v7/widget/au$a;->leftMargin:I
    ...
    iget v8, v6, Landroid/support/v7/widget/au$a;->leftMargin:I

    add-int/2addr v7, v8

    :goto_2
    iget v8, v6, Landroid/support/v7/widget/au$a;->rightMargin:I
    ...
    :cond_6
    iget v8, v6, Landroid/support/v7/widget/au$a;->topMargin:I
    ...
    iget v3, v6, Landroid/support/v7/widget/au$a;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    :goto_5
    invoke-static {v13}, Landroid/support/v4/view/r;->j(Landroid/view/View;)I
    ...
    check-cast v12, Landroid/support/v7/widget/au$a;

    iget v0, v12, Landroid/support/v7/widget/au$a;->width:I

    const/4 v2, -0x1

    if-ne v0, v2, :cond_12

    iget v14, v12, Landroid/support/v7/widget/au$a;->height:I

    invoke-virtual {v1}, Landroid/view/View;->getMeasuredHeight()I

    move-result v0

    iput v0, v12, Landroid/support/v7/widget/au$a;->height:I
    ...
    iput v14, v12, Landroid/support/v7/widget/au$a;->height:I
