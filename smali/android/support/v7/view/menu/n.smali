...
.method final a(IIZZ)V
    ...
    iget p3, p0, Landroid/support/v7/view/menu/n;->b:I

    iget-object p4, p0, Landroid/support/v7/view/menu/n;->a:Landroid/view/View;

    invoke-static {p4}, Landroid/support/v4/view/r;->e(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Landroid/support/v4/view/e;->a(II)I
    ...
    iget-object p3, p0, Landroid/support/v7/view/menu/n;->a:Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v7/view/menu/n;->d:Landroid/content/Context;
    ...
    iput-object p4, v0, Landroid/support/v7/view/menu/m;->e:Landroid/graphics/Rect;
...
.method public final b()Landroid/support/v7/view/menu/m;
    .locals 14
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/n;->d:Landroid/content/Context;
    ...
    iget-object v8, p0, Landroid/support/v7/view/menu/n;->d:Landroid/content/Context;

    iget-object v9, p0, Landroid/support/v7/view/menu/n;->e:Landroid/support/v7/view/menu/h;

    iget-object v10, p0, Landroid/support/v7/view/menu/n;->a:Landroid/view/View;

    iget v11, p0, Landroid/support/v7/view/menu/n;->g:I

    iget v12, p0, Landroid/support/v7/view/menu/n;->h:I

    iget-boolean v13, p0, Landroid/support/v7/view/menu/n;->f:Z
...
.method public final c()Z
    ...
    :cond_1
    invoke-virtual {p0, v2, v2, v2, v2}, Landroid/support/v7/view/menu/n;->a(IIZZ)V
