...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Landroid/support/v7/view/menu/h;->e:I
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/h;->y:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v1, p0, Landroid/support/v7/view/menu/h;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/h;->m:Landroid/content/res/Resources;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Landroid/support/v7/view/menu/h;->c:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Landroid/support/v7/view/menu/h;->p:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/h;->d:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Landroid/support/v7/view/menu/h;->r:Ljava/util/ArrayList;

    iput-boolean p1, p0, Landroid/support/v7/view/menu/h;->s:Z

    iget-object v1, p0, Landroid/support/v7/view/menu/h;->m:Landroid/content/res/Resources;
...
.method private static a(Ljava/util/ArrayList;I)I
    ...
    iget v1, v1, Landroid/support/v7/view/menu/j;->a:I
...
.method private a(ILandroid/view/KeyEvent;)Landroid/support/v7/view/menu/j;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->y:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    invoke-direct {p0, v0, p1, p2}, Landroid/support/v7/view/menu/h;->a(Ljava/util/List;ILandroid/view/KeyEvent;)V
...
.method private a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    iget v9, p0, Landroid/support/v7/view/menu/h;->e:I
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/h;->t:Landroid/view/ContextMenu$ContextMenuInfo;

    if-eqz p1, :cond_1

    iget-object p1, p0, Landroid/support/v7/view/menu/h;->t:Landroid/view/ContextMenu$ContextMenuInfo;

    iput-object p1, v1, Landroid/support/v7/view/menu/j;->e:Landroid/view/ContextMenu$ContextMenuInfo;

    :cond_1
    iget-object p1, p0, Landroid/support/v7/view/menu/h;->c:Ljava/util/ArrayList;

    iget-object p2, p0, Landroid/support/v7/view/menu/h;->c:Ljava/util/ArrayList;

    invoke-static {p2, v0}, Landroid/support/v7/view/menu/h;->a(Ljava/util/ArrayList;I)I
...
.method private a(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    :cond_0
    iget-object v3, p0, Landroid/support/v7/view/menu/h;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Landroid/support/v7/view/menu/h;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v8, p1, p2, p3}, Landroid/support/v7/view/menu/h;->a(Ljava/util/List;ILandroid/view/KeyEvent;)V
...
.method final a(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/h;->g:Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/support/v7/view/menu/j;)Z
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/h;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_2
    invoke-interface {v3, p1}, Landroid/support/v7/view/menu/o;->b(Landroid/support/v7/view/menu/j;)Z
...
.method public final a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/o;I)Z
    ...
    iget-object v2, p1, Landroid/support/v7/view/menu/j;->d:Landroid/support/v4/view/c;
    ...
    invoke-direct {p3, v5, p0, p1}, Landroid/support/v7/view/menu/u;-><init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/j;)V
    ...
    :cond_7
    iget-object p3, p0, Landroid/support/v7/view/menu/h;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_9
    iget-object p2, p0, Landroid/support/v7/view/menu/h;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public b(Landroid/support/v7/view/menu/j;)Z
    ...
    :cond_2
    invoke-interface {v3, p1}, Landroid/support/v7/view/menu/o;->c(Landroid/support/v7/view/menu/j;)Z
...
.method public final e()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/view/menu/h;->v:Z
...
.method public hasVisibleItems()Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/h;->c:Ljava/util/ArrayList;
...
.method public final i()V
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/h;->z:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->d:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Landroid/support/v7/view/menu/h;->r:Ljava/util/ArrayList;
    ...
    :cond_5
    iput-boolean v2, p0, Landroid/support/v7/view/menu/h;->s:Z
...
.method public performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/view/menu/h;->a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/o;I)Z
...
.method public setGroupVisible(IZ)V
    ...
    invoke-virtual {v4, p2}, Landroid/support/v7/view/menu/j;->b(Z)Z
