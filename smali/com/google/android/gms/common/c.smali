...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/internal/be;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bf;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/be;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/be;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/be;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/ax;)Lcom/google/android/gms/common/api/internal/aw;
    .locals 2
    ...
    iput-object p0, v1, Lcom/google/android/gms/common/api/internal/aw;->a:Landroid/content/Context;
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/aw;->a()V
...
.method private final a(Landroid/content/Context;Landroid/app/NotificationManager;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/internal/be;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method public static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/g;->a(Landroid/support/v4/app/m;Ljava/lang/String;)V
...
.method public static a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/bd;ILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1

    const-string v0, "d"

    invoke-static {p0, p2, v0}, Lcom/google/android/gms/common/m;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/bf;->a(Lcom/google/android/gms/common/api/internal/bd;Landroid/content/Intent;)Lcom/google/android/gms/common/internal/bf;

    move-result-object p1

    invoke-static {p0, p2, p1, p3}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bf;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/google/android/gms/common/c;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final a(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    :cond_1
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/be;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v1

    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/be;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/google/android/gms/common/internal/ag;->a(Z)V
    ...
    sget v2, Lcom/google/android/gms/a$b;->common_open_on_phone:I
    ...
    invoke-direct {p0, p1, v4}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;Landroid/app/NotificationManager;)Ljava/lang/String;
    ...
    :cond_3
    new-instance v5, Landroid/support/v4/app/aa$d;

    invoke-direct {v5, p1}, Landroid/support/v4/app/aa$d;-><init>(Landroid/content/Context;)V

    const v6, 0x108008a

    invoke-virtual {v5, v6}, Landroid/support/v4/app/aa$d;->a(I)Landroid/support/v4/app/aa$d;

    move-result-object v5

    sget v6, Lcom/google/android/gms/a$b;->common_google_play_services_notification_ticker:I

    invoke-virtual {v3, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v5, v3}, Landroid/support/v4/app/aa$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$d;
    ...
    iget-object v7, v3, Landroid/support/v4/app/aa$d;->M:Landroid/app/Notification;

    iput-wide v5, v7, Landroid/app/Notification;->when:J

    invoke-virtual {v3, v0}, Landroid/support/v4/app/aa$d;->a(Z)Landroid/support/v4/app/aa$d;

    move-result-object v3

    iput-object p3, v3, Landroid/support/v4/app/aa$d;->e:Landroid/app/PendingIntent;

    invoke-virtual {v3, v1}, Landroid/support/v4/app/aa$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$d;

    move-result-object p3

    invoke-virtual {p3, v2}, Landroid/support/v4/app/aa$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$d;

    move-result-object p3

    iput-boolean v0, p3, Landroid/support/v4/app/aa$d;->w:Z
    ...
    invoke-virtual {p3, v0}, Landroid/support/v4/app/aa$d;->a(Landroid/support/v4/app/aa$e;)Landroid/support/v4/app/aa$d;
    ...
    iput-object p1, p3, Landroid/support/v4/app/aa$d;->H:Ljava/lang/String;

    :cond_4
    invoke-virtual {p3}, Landroid/support/v4/app/aa$d;->d()Landroid/app/Notification;
    ...
    sget-object p3, Lcom/google/android/gms/common/w;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
