...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/auth/api/signin/internal/k;->b:Lcom/google/android/gms/auth/api/signin/internal/u;

    iget-object p1, p0, Lcom/google/android/gms/auth/api/signin/internal/k;->b:Lcom/google/android/gms/auth/api/signin/internal/u;

    invoke-virtual {p1}, Lcom/google/android/gms/auth/api/signin/internal/u;->a()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/gms/auth/api/signin/internal/k;->c:Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    iget-object p1, p0, Lcom/google/android/gms/auth/api/signin/internal/k;->b:Lcom/google/android/gms/auth/api/signin/internal/u;

    invoke-virtual {p1}, Lcom/google/android/gms/auth/api/signin/internal/u;->b()Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
...
.method public static declared-synchronized a(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/k;
    ...
    const-class v0, Lcom/google/android/gms/auth/api/signin/internal/k;
    ...
    invoke-static {p0}, Lcom/google/android/gms/auth/api/signin/internal/k;->b(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/k;
...
.method private static declared-synchronized b(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/k;
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/auth/api/signin/internal/k;->a:Lcom/google/android/gms/auth/api/signin/internal/k;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/android/gms/auth/api/signin/internal/k;

    invoke-direct {v1, p0}, Lcom/google/android/gms/auth/api/signin/internal/k;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/google/android/gms/auth/api/signin/internal/k;->a:Lcom/google/android/gms/auth/api/signin/internal/k;

    :cond_0
    sget-object p0, Lcom/google/android/gms/auth/api/signin/internal/k;->a:Lcom/google/android/gms/auth/api/signin/internal/k;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a()V
    ...
    iget-object v1, v0, Lcom/google/android/gms/auth/api/signin/internal/u;->a:Ljava/util/concurrent/locks/Lock;
    ...
    :try_start_1
    iget-object v1, v0, Lcom/google/android/gms/auth/api/signin/internal/u;->b:Landroid/content/SharedPreferences;
    ...
    :try_start_2
    iget-object v0, v0, Lcom/google/android/gms/auth/api/signin/internal/u;->a:Ljava/util/concurrent/locks/Lock;
