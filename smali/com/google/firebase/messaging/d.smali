...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-static {v3, v9, v8}, Lcom/google/firebase/iid/y;->a(Landroid/content/Context;ILandroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v10}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v10

    invoke-static {v9, v10, v8}, Lcom/google/firebase/iid/y;->a(Landroid/content/Context;ILandroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    :cond_10
    new-instance v3, Landroid/support/v4/app/aa$d;

    iget-object v8, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;

    invoke-direct {v3, v8}, Landroid/support/v4/app/aa$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v1}, Landroid/support/v4/app/aa$d;->a(Z)Landroid/support/v4/app/aa$d;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/aa$d;->a(I)Landroid/support/v4/app/aa$d;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/aa$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$d;
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/app/aa$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$d;

    new-instance v4, Landroid/support/v4/app/aa$c;

    invoke-direct {v4}, Landroid/support/v4/app/aa$c;-><init>()V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/aa$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aa$c;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/v4/app/aa$d;->a(Landroid/support/v4/app/aa$e;)Landroid/support/v4/app/aa$d;
    ...
    iput v4, v3, Landroid/support/v4/app/aa$d;->B:I

    :cond_13
    if-eqz v0, :cond_14

    invoke-virtual {v3, v0}, Landroid/support/v4/app/aa$d;->a(Landroid/net/Uri;)Landroid/support/v4/app/aa$d;

    :cond_14
    if-eqz v9, :cond_15

    iput-object v9, v3, Landroid/support/v4/app/aa$d;->e:Landroid/app/PendingIntent;

    :cond_15
    if-eqz v10, :cond_16

    iget-object v0, v3, Landroid/support/v4/app/aa$d;->M:Landroid/app/Notification;

    iput-object v10, v0, Landroid/app/Notification;->deleteIntent:Landroid/app/PendingIntent;

    :cond_16
    invoke-virtual {v3}, Landroid/support/v4/app/aa$d;->d()Landroid/app/Notification;
