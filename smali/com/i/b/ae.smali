...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/i/b/ae;->a:Ljava/lang/StringBuilder;

    return-void
.end method

.method static a(Landroid/content/res/Resources;Lcom/i/b/w;)I
    .locals 6
    ...
    iget-object v0, p1, Lcom/i/b/w;->d:Landroid/net/Uri;
...
.method static a(Landroid/content/Context;Lcom/i/b/w;)Landroid/content/res/Resources;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/FileNotFoundException;
...
.method static a(Landroid/content/Context;)Lcom/i/b/j;
    .locals 1
    ...
    new-instance v0, Lcom/i/b/s;

    invoke-direct {v0, p0}, Lcom/i/b/s;-><init>(Landroid/content/Context;)V
    :try_end_0
    ...
    :catch_0
    new-instance v0, Lcom/i/b/ad;

    invoke-direct {v0, p0}, Lcom/i/b/ad;-><init>(Landroid/content/Context;)V
...
.method static a(Lcom/i/b/c;)Ljava/lang/String;
    .locals 1

    const-string v0, ""

    invoke-static {p0, v0}, Lcom/i/b/ae;->a(Lcom/i/b/c;Ljava/lang/String;)Ljava/lang/String;
...
.method static a(Lcom/i/b/c;Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    ...
    iget-object p1, p0, Lcom/i/b/c;->k:Lcom/i/b/a;
    ...
    :cond_0
    iget-object p0, p0, Lcom/i/b/c;->l:Ljava/util/List;
...
.method static a(Lcom/i/b/w;)Ljava/lang/String;
    .locals 6

    sget-object v0, Lcom/i/b/ae;->a:Ljava/lang/StringBuilder;
    ...
    iget-boolean v2, p0, Lcom/i/b/w;->p:Z
    ...
    iget v2, p0, Lcom/i/b/w;->n:F

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(C)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/i/b/w;->o:F
    ...
    iget v2, p0, Lcom/i/b/w;->h:I

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(C)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/i/b/w;->i:I
    ...
    :cond_4
    iget-boolean v2, p0, Lcom/i/b/w;->j:Z
    ...
    :cond_5
    iget-boolean v2, p0, Lcom/i/b/w;->k:Z
    ...
    :cond_6
    :goto_3
    iget-object v2, p0, Lcom/i/b/w;->g:Ljava/util/List;
    ...
    iget-object v5, p0, Lcom/i/b/w;->g:Ljava/util/List;

    invoke-interface {v5, v4}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/i/b/ac;

    invoke-interface {v5}, Lcom/i/b/ac;->b()Ljava/lang/String;
...
.method static a(Landroid/os/Looper;)V
    ...
    new-instance v0, Lcom/i/b/ae$1;

    invoke-direct {v0, p0}, Lcom/i/b/ae$1;-><init>(Landroid/os/Looper;)V
...
.method static a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/i/b/ae;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
